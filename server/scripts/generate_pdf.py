            ...
            if photos:
                ...
                for i, photo_path in enumerate(photos):
                    ...
                    if rows_on_this_page >= max_rows_per_page and col == 0:
                        print(f"[PDF checklist] 照片 {i+1}: 当前页已满 {max_rows_per_page} 行，换页")
                        c.showPage()
                    ...
                    print(f"[PDF checklist] 照片 {i+1}/{len(photos)}: row={rows_on_this_page}, col={col}, photo_y={photo_y:.1f}, photo_bottom={photo_bottom:.1f}")
                ...
                print(f"[PDF checklist] 绘制完成，最终 y={y:.1f}, 共{rows_on_this_page}行")
...
def draw_defect_statistics_table(c, width, margin, y, height, data):
    ...
    # AQL抽样检验标准表 (ISO 2859-1 / ANSI/ASQ Z1.4, 正常检验水平II)
    # 格式: { 抽样数量上限: { AQL值: (Ac, Re) } }
    # Ac = 允收数 (Accept), Re = 拒收数 (Reject)
    aql_table = {
        2:   {'0.40': (0,1), '0.65': (0,1), '1.0': (0,1), '1.5': (0,1), '2.5': (0,1), '4.0': (0,1), '6.5': (1,2)},
        3:   {'0.40': (0,1), '0.65': (0,1), '1.0': (0,1), '1.5': (0,1), '2.5': (0,1), '4.0': (0,1), '6.5': (1,2)},
        5:   {'0.40': (0,1), '0.65': (0,1), '1.0': (0,1), '1.5': (0,1), '2.5': (0,1), '4.0': (1,2), '6.5': (1,2)},
        8:   {'0.40': (0,1), '0.65': (0,1), '1.0': (0,1), '1.5': (0,1), '2.5': (1,2), '4.0': (1,2), '6.5': (2,3)},
        13:  {'0.40': (0,1), '0.65': (0,1), '1.0': (0,1), '1.5': (1,2), '2.5': (1,2), '4.0': (2,3), '6.5': (3,4)},
        20:  {'0.40': (0,1), '0.65': (0,1), '1.0': (1,2), '1.5': (1,2), '2.5': (2,3), '4.0': (3,4), '6.5': (5,6)},
        32:  {'0.40': (0,1), '0.65': (1,2), '1.0': (1,2), '1.5': (2,3), '2.5': (3,4), '4.0': (5,6), '6.5': (7,8)},
        50:  {'0.40': (1,2), '0.65': (1,2), '1.0': (2,3), '1.5': (3,4), '2.5': (5,6), '4.0': (7,8), '6.5': (10,11)},
        80:  {'0.40': (1,2), '0.65': (2,3), '1.0': (3,4), '1.5': (5,6), '2.5': (7,8), '4.0': (10,11), '6.5': (14,15)},
        125: {'0.40': (2,3), '0.65': (3,4), '1.0': (5,6), '1.5': (7,8), '2.5': (10,11), '4.0': (14,15), '6.5': (21,22)},
        200: {'0.40': (3,4), '0.65': (5,6), '1.0': (7,8), '1.5': (10,11), '2.5': (14,15), '4.0': (21,22), '6.5': (21,22)},
        315: {'0.40': (5,6), '0.65': (7,8), '1.0': (10,11), '1.5': (14,15), '2.5': (21,22), '4.0': (21,22), '6.5': (21,22)},
        500: {'0.40': (7,8), '0.65': (10,11), '1.0': (14,15), '1.5': (21,22), '2.5': (21,22), '4.0': (21,22), '6.5': (21,22)},
        800: {'0.40': (10,11), '0.65': (14,15), '1.0': (21,22), '1.5': (21,22), '2.5': (21,22), '4.0': (21,22), '6.5': (21,22)},
    }
    ...
    def get_aql_row(size):
        ...
        return aql_table[800]  # 超过800使用最大值
