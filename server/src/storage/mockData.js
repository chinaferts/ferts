...
export function mockGetChecklist(id) {
    // 特殊处理通用模板
    if (id === 'universal') {
...
export function mockCreateChecklist(data) {
    const newChecklist = {
...
export function mockUpdateChecklist(id, data) {
    // 特殊处理通用模板更新
    if (id === 'universal') {
        if (data.name)
            universalTemplateData.name = data.name;
        if (data.description)
            universalTemplateData.description = data.description;
        if (data.category)
            universalTemplateData.category = data.category;
        if (data.categories)
            universalTemplateData.categories = data.categories;
...
export function mockGetChecklistItems(checklistId) {
    return checklistItems.filter(i => i.checklist_id === checklistId).sort((a, b) => a.order - b.order);
}
export function mockCreateChecklistItem(data) {
    const newItem = {
...
export function mockDeleteChecklistItem(id) {
...
export function mockGetInspections(filters) {
...
export function mockGetInspection(id) {
...
export function mockCreateInspection(data) {
    const newInspection = {
...
export function mockUpdateInspection(id, data) {
...
export function mockGetInspectionRecords(inspectionId) {
    return inspectionRecords.filter(r => r.inspection_id === inspectionId);
}
export function mockCreateInspectionRecord(data) {
    const newRecord = {
        id: String(nextRecordId++),
        ...data,
        created_at: new Date().toISOString()
...
export function mockGetDefects(inspectionId) {
    if (inspectionId) {
        return defects.filter(d => d.inspection_id === inspectionId);
    }
    return defects;
}
export function mockCreateDefect(data) {
    const newDefect = {
...
export function mockDeleteDefect(id) {
